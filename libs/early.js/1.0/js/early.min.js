...
d){return c.Modernizr&&typeof c.Detectizr?Modernizr.Detectizr.device.browserVersion:""}(window),earlyBrowserEngine=function(c){return c.Modernizr&&typeof c.Detectizr?Modernizr.Detectizr.device.browserEngine:""}(window),earlyOs=function(c){return c.Modernizr&&typeof c.Detectizr?Modernizr.Detectizr.device.os:""}(window),earlyOsVersion=function(c){return c.Modernizr&&typeof c.Detectizr?Modernizr.Detectizr.device.osVersion:""}(window);
